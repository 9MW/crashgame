...
{
    static const char tfmodule[] = "TIFFDeferStrileArrayWriting";
...
{
	static const char tfmodule[] = "TIFFRewriteDirectory";
...
{
	static const char tfmodule[] = "TIFFWriteDirectorySec";
	uint32 ndir;
	TIFFDirEntry* dir;
	uint32 dirsize;
	void* dirmem;
	...
	while (1)
	{
		...
		{
			TIFFErrorExt(tif->tif_clientdata,tfmodule,"Maximum TIFF file size exceeded");
			goto bad;
		}
	...
	{
		TIFFErrorExt(tif->tif_clientdata,tfmodule,"IO error writing directory");
		goto bad;
	}
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagSampleformatArray";
	void* conv;
	uint32 i;
	int ok;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagBytePerSample";
	uint8* m;
	uint8* na;
	uint16 nb;
	int o;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagSbytePerSample";
	int8* m;
	int8* na;
	uint16 nb;
	int o;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagShortPerSample";
	uint16* m;
	uint16* na;
	uint16 nb;
	int o;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagSshortPerSample";
	int16* m;
	int16* na;
	uint16 nb;
	int o;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagLongPerSample";
	uint32* m;
	uint32* na;
	uint16 nb;
	int o;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagSlongPerSample";
	int32* m;
	int32* na;
	uint16 nb;
	int o;
...
static int TIFFWriteDirectoryTagFloatPerSample(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, float value)
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagFloatPerSample";
	float* m;
	float* na;
	uint16 nb;
	int o;
...
static int TIFFWriteDirectoryTagDoublePerSample(TIFF* tif, uint32* ndir, TIFFDirEntry* dir, uint16 tag, double value)
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagDoublePerSample";
	double* m;
	double* na;
	uint16 nb;
	int o;
...
{
    static const char tfmodule[] = "TIFFWriteDirectoryTagLongLong8Array";
    int o;
    int write_aslong4;
...
{
    static const char tfmodule[] = "TIFFWriteDirectoryTagIfdIfd8Array";
    uint64* ma;
    uint32 mb;
    uint32* p;
    uint32* q;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagShortLongLong8Array";
	uint64* ma;
	uint32 mb;
	uint8 n;
	int o;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagColormap";
	uint32 m;
	uint16* n;
	int o;
	if (dir==NULL)
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagTransferfunction";
	uint32 m;
	uint16 n;
	uint16* o;
	int p;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagSubifd";
	uint64 m;
	int n;
	...
	if (!(tif->tif_flags&TIFF_BIGTIFF))
	{
		...
		for (p=0; p < tif->tif_dir.td_nsubifd; p++)
		{
                        ...
                        if( *pa > 0xFFFFFFFFUL)
                        {
                            TIFFErrorExt(tif->tif_clientdata,tfmodule,"Illegal value for SubIFD tag");
                            _TIFFfree(o);
                            return(0);
                        }
			*pb++=(uint32)(*pa++);
...
{
        static const char tfmodule[] = "TIFFWriteDirectoryTagCheckedRational";
	uint32 m[2];
	assert(sizeof(uint32)==4);
        if( value < 0 )
        {
            TIFFErrorExt(tif->tif_clientdata,tfmodule,"Negative value is illegal");
            return 0;
        }
        else if( value != value )
        {
            TIFFErrorExt(tif->tif_clientdata,tfmodule,"Not-a-number value is illegal");
            return 0;
        }
	else if (value==0.0)
	{
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagCheckedRationalArray";
	uint32* m;
	float* na;
	uint32* nb;
	uint32 nc;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagCheckedSrationalArray";
	int32* m;
	float* na;
	int32* nb;
	uint32 nc;
...
{
	static const char tfmodule[] = "TIFFWriteDirectoryTagData";
	uint32 m;
	m=0;
	while (m<(*ndir))
	{
	...
	else
	{
		...
		if (!SeekOK(tif,na))
		{
			TIFFErrorExt(tif->tif_clientdata,tfmodule,"IO error writing tag data");
			return(0);
		}
...
{
	static const char tfmodule[] = "TIFFLinkDirectory";
...
{
    static const char tfmodule[] = "TIFFResetField";
