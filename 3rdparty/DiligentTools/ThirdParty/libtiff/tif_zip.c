...
{
	static const char tfmodule[] = "ZIPSetupDecode";
	...
	if ((sp->state & ZSTATE_INIT_DECODE) == 0 &&
		...
		TIFFErrorExt(tif->tif_clientdata, tfmodule, "%s", SAFE_MSG(sp));
		return (0);
	} else {
...
{
	static const char tfmodule[] = "ZIPDecode";
	ZIPState* sp = DecoderState(tif);
...
{
	static const char tfmodule[] = "ZIPSetupEncode";
...
{
	static const char tfmodule[] = "ZIPEncode";
	ZIPState *sp = EncoderState(tif);
...
{
	static const char tfmodule[] = "ZIPPostEncode";
	ZIPState *sp = EncoderState(tif);
	int state;
...
{
	static const char tfmodule[] = "ZIPVSetField";
	ZIPState* sp = ZState(tif);
...
{
	static const char tfmodule[] = "TIFFInitZIP";
	ZIPState* sp;
