...
{
	static const char tfmodule[] = "LogL16Decode";
...
{
	static const char tfmodule[] = "LogLuvDecode24";
	LogLuvState* sp = DecoderState(tif);
	tmsize_t cc;
	tmsize_t i;
	tmsize_t npixels;
...
{
	static const char tfmodule[] = "LogLuvDecode32";
	LogLuvState* sp;
	int shft;
	tmsize_t i;
	tmsize_t npixels;
...
{
	static const char tfmodule[] = "LogL16Encode";
...
{
	static const char tfmodule[] = "LogLuvEncode24";
	LogLuvState* sp = EncoderState(tif);
	tmsize_t i;
	tmsize_t npixels;
	tmsize_t occ;
...
{
	static const char tfmodule[] = "LogLuvEncode32";
	LogLuvState* sp = EncoderState(tif);
	int shft;
	tmsize_t i;
	tmsize_t j;
...
{
	static const char tfmodule[] = "LogL16InitState";
	...
	if (multiply_ms(sp->tbuflen, sizeof (int16)) == 0 ||
		...
		TIFFErrorExt(tif->tif_clientdata, tfmodule, "No space for SGILog translation buffer");
		return (0);
	}
	return (1);
}
...
{
	static const char tfmodule[] = "LogLuvInitState";
	TIFFDirectory* td = &tif->tif_dir;
	LogLuvState* sp = DecoderState(tif);
...
{
	static const char tfmodule[] = "LogLuvSetupDecode";
	LogLuvState* sp = DecoderState(tif);
	TIFFDirectory* td = &tif->tif_dir;
...
{
	static const char tfmodule[] = "LogLuvSetupEncode";
	LogLuvState* sp = EncoderState(tif);
	TIFFDirectory* td = &tif->tif_dir;
...
{
	static const char tfmodule[] = "LogLuvVSetField";
	LogLuvState* sp = DecoderState(tif);
	int bps, fmt;
...
{
	static const char tfmodule[] = "TIFFInitSGILog";
	LogLuvState* sp;
