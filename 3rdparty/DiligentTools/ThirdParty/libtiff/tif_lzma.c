...
{
	static const char tfmodule[] = "LZMAPreDecode";
	LZMAState* sp = DecoderState(tif);
	lzma_ret ret;
...
{
	static const char tfmodule[] = "LZMADecode";
	LZMAState* sp = DecoderState(tif);
...
{
	static const char tfmodule[] = "LZMAPreEncode";
	LZMAState *sp = EncoderState(tif);
	lzma_ret ret;
...
{
	static const char tfmodule[] = "LZMAEncode";
	LZMAState *sp = EncoderState(tif);
...
{
	static const char tfmodule[] = "LZMAPostEncode";
	LZMAState *sp = EncoderState(tif);
	lzma_ret ret;
	...
	do {
		...
		case LZMA_OK:
			...
			break;
		default:
			TIFFErrorExt(tif->tif_clientdata, tfmodule, "Liblzma error: %s",
				     LZMAStrerror(ret));
			return 0;
		}
...
{
	static const char tfmodule[] = "LZMAVSetField";
	LZMAState* sp = LState(tif);
...
{
	static const char tfmodule[] = "TIFFInitLZMA";
	LZMAState* sp;
