...
#ifndef FLATBUFFERS_GENERATED_CSBINARY_FLATBUFFERS_H_
#define FLATBUFFERS_GENERATED_CSBINARY_FLATBUFFERS_H_
...
struct WidgetOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Position *position() const {
    return GetStruct<const flatbuffers::Position *>(VT_POSITION);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::RotationSkew>(verifier, VT_ROTATIONSKEW) &&
           ...
           VerifyField<flatbuffers::Position>(verifier, VT_POSITION) &&
           VerifyField<flatbuffers::Scale>(verifier, VT_SCALE) &&
           VerifyField<flatbuffers::AnchorPoint>(verifier, VT_ANCHORPOINT) &&
           VerifyField<flatbuffers::Color>(verifier, VT_COLOR) &&
           VerifyField<flatbuffers::FlatSize>(verifier, VT_SIZE) &&
...
struct WidgetOptionsBuilder {
  ...
  void add_position(const flatbuffers::Position *position) {
...
inline flatbuffers::Offset<WidgetOptions> CreateWidgetOptions(
    ...
    int32_t actionTag = 0,
    const flatbuffers::RotationSkew *rotationSkew = 0,
    int32_t zOrder = 0,
    bool visible = true,
    uint8_t alpha = 255,
    int32_t tag = 0,
    const flatbuffers::Position *position = 0,
    const flatbuffers::Scale *scale = 0,
    const flatbuffers::AnchorPoint *anchorPoint = 0,
    const flatbuffers::Color *color = 0,
    const flatbuffers::FlatSize *size = 0,
    bool flipX = false,
    bool flipY = false,
...
struct ButtonOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::CapInsets>(verifier, VT_CAPINSETS) &&
           VerifyField<flatbuffers::FlatSize>(verifier, VT_SCALE9SIZE) &&
           ...
           VerifyField<flatbuffers::Color>(verifier, VT_OUTLINECOLOR) &&
           VerifyField<int32_t>(verifier, VT_OUTLINESIZE) &&
           VerifyField<uint8_t>(verifier, VT_SHADOWENABLED) &&
           VerifyField<flatbuffers::Color>(verifier, VT_SHADOWCOLOR) &&
...
inline flatbuffers::Offset<ButtonOptions> CreateButtonOptions(
    ...
    const flatbuffers::CapInsets *capInsets = 0,
    const flatbuffers::FlatSize *scale9Size = 0,
    bool scale9Enabled = false,
    bool displaystate = true,
    bool outlineEnabled = false,
    const flatbuffers::Color *outlineColor = 0,
    int32_t outlineSize = 1,
    bool shadowEnabled = false,
    const flatbuffers::Color *shadowColor = 0,
...
struct PanelOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::Color>(verifier, VT_BGCOLOR) &&
           VerifyField<flatbuffers::Color>(verifier, VT_BGSTARTCOLOR) &&
           VerifyField<flatbuffers::Color>(verifier, VT_BGENDCOLOR) &&
           VerifyField<int32_t>(verifier, VT_COLORTYPE) &&
           VerifyField<uint8_t>(verifier, VT_BGCOLOROPACITY) &&
           VerifyField<flatbuffers::ColorVector>(verifier, VT_COLORVECTOR) &&
           VerifyField<flatbuffers::CapInsets>(verifier, VT_CAPINSETS) &&
           VerifyField<flatbuffers::FlatSize>(verifier, VT_SCALE9SIZE) &&
...
inline flatbuffers::Offset<PanelOptions> CreatePanelOptions(
    ...
    const flatbuffers::Color *bgColor = 0,
    const flatbuffers::Color *bgStartColor = 0,
    const flatbuffers::Color *bgEndColor = 0,
    int32_t colorType = 0,
    uint8_t bgColorOpacity = 255,
    const flatbuffers::ColorVector *colorVector = 0,
    const flatbuffers::CapInsets *capInsets = 0,
    const flatbuffers::FlatSize *scale9Size = 0,
...
struct ScrollViewOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::FlatSize>(verifier, VT_SCALE9SIZE) &&
           VerifyField<uint8_t>(verifier, VT_BACKGROUNDSCALE9ENABLED) &&
           VerifyField<flatbuffers::FlatSize>(verifier, VT_INNERSIZE) &&
           VerifyField<int32_t>(verifier, VT_DIRECTION) &&
...
inline flatbuffers::Offset<ScrollViewOptions> CreateScrollViewOptions(
    ...
    const flatbuffers::FlatSize *scale9Size = 0,
    bool backGroundScale9Enabled = false,
    const flatbuffers::FlatSize *innerSize = 0,
    int32_t direction = 0,
...
struct EasingData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const flatbuffers::Position *> *points() const {
    return GetPointer<const flatbuffers::Vector<const flatbuffers::Position *> *>(VT_POINTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct EasingDataBuilder {
  ...
  void add_points(flatbuffers::Offset<flatbuffers::Vector<const flatbuffers::Position *>> points) {
...
inline flatbuffers::Offset<EasingData> CreateEasingData(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t type = -1,
    flatbuffers::Offset<flatbuffers::Vector<const flatbuffers::Position *>> points = 0) {
...
inline flatbuffers::Offset<EasingData> CreateEasingDataDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    int32_t type = -1,
    const std::vector<flatbuffers::Position> *points = nullptr) {
  auto points__ = points ? _fbb.CreateVectorOfStructs<flatbuffers::Position>(*points) : 0;
...
struct Node3DOption FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector3 *position3D() const {
    return GetStruct<const flatbuffers::Vector3 *>(VT_POSITION3D);
  }
  const flatbuffers::Vector3 *rotation3D() const {
    return GetStruct<const flatbuffers::Vector3 *>(VT_ROTATION3D);
  }
  const flatbuffers::Vector3 *scale3D() const {
    return GetStruct<const flatbuffers::Vector3 *>(VT_SCALE3D);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_NODEOPTIONS) &&
           verifier.VerifyTable(nodeOptions()) &&
           VerifyField<flatbuffers::Vector3>(verifier, VT_POSITION3D) &&
           VerifyField<flatbuffers::Vector3>(verifier, VT_ROTATION3D) &&
           VerifyField<flatbuffers::Vector3>(verifier, VT_SCALE3D) &&
...
struct Node3DOptionBuilder {
  ...
  void add_position3D(const flatbuffers::Vector3 *position3D) {
    fbb_.AddStruct(Node3DOption::VT_POSITION3D, position3D);
  }
  void add_rotation3D(const flatbuffers::Vector3 *rotation3D) {
    fbb_.AddStruct(Node3DOption::VT_ROTATION3D, rotation3D);
  }
  void add_scale3D(const flatbuffers::Vector3 *scale3D) {
...
inline flatbuffers::Offset<Node3DOption> CreateNode3DOption(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::WidgetOptions> nodeOptions = 0,
    const flatbuffers::Vector3 *position3D = 0,
    const flatbuffers::Vector3 *rotation3D = 0,
    const flatbuffers::Vector3 *scale3D = 0,
...
#endif  // FLATBUFFERS_GENERATED_CSBINARY_FLATBUFFERS_H_
